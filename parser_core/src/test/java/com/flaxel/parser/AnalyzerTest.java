...
public class AnalyzerTest {
	...
	public void testAnalyzePathNull() throws URISyntaxException {
		Path nullPath = null;
		Path path = Paths.get(getClass().getClassLoader().getResource("com/flaxel/parser/Analyzed.txt").toURI());
	...
	public void testAnalyzeZipFileNull() {
		File nullFile = null;
		File file = new File(getClass().getClassLoader().getResource("com/flaxel/parser/Analyzed.zip").getFile());
	...
	public void testAnalyzeZipPathNull() throws URISyntaxException {
		Path nullPath = null;
		Path path = Paths.get(getClass().getClassLoader().getResource("com/flaxel/parser/Analyzed.zip").toURI());
	...
	public void testAnalyzeFolderFileNotFolder() {
		File folder = new File(getClass().getClassLoader().getResource("com/flaxel/parser/Analyzed.zip").getFile());
		assertThrows(IllegalArgumentException.class, () -> Analyzer.analyzeFolder(folder, Analyzer.DEFAULT_FILE_FILTER,
				Analyzer.DEFAULT_FILE_PROBLEM_HANDLER, Analyzer.DEFAULT_UNIT_FILTER, DEFAULT_FILE_UNIT_HANDLER));
		assertThrows(IllegalArgumentException.class, () -> Analyzer.analyzeFolder(folder, Analyzer.DEFAULT_FILE_FILTER,
				Analyzer.DEFAULT_FILE_PROBLEM_HANDLER, DEFAULT_FILE_UNIT_HANDLER));
	...
	public void testAnalyzeFolderPathNotFolder() throws URISyntaxException {
		Path folder = Paths.get(getClass().getClassLoader().getResource("com/flaxel/parser/Analyzed.zip").toURI());
		assertThrows(IllegalArgumentException.class, () -> Analyzer.analyzeFolder(folder, Analyzer.DEFAULT_FILE_FILTER,
				Analyzer.DEFAULT_FILE_PROBLEM_HANDLER, Analyzer.DEFAULT_UNIT_FILTER, DEFAULT_FILE_UNIT_HANDLER));
		assertThrows(IllegalArgumentException.class, () -> Analyzer.analyzeFolder(folder, Analyzer.DEFAULT_FILE_FILTER,
				Analyzer.DEFAULT_FILE_PROBLEM_HANDLER, DEFAULT_FILE_UNIT_HANDLER));
