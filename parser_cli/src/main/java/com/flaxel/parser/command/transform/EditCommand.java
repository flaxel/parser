 ...
 * @since 1.0.0
 */
@Command(name = "edit", description = "edit source code", sortOptions = true)
public class EditCommand implements Runnable {
	...
	/**
	 * new value for the source code
	 */
	@Parameters(index = "2", description = "new content")
	...
	public void run() {
		...
		RenameHandler handler = new RenameHandler(regex, (oldValue) -> newValue).verbose(Console.getOutput());
